  ...
  return loading ? null : (
    <div className="all-data-container">
      <div className="all-data-col-1">
        ...
        <div className="all-data-summary-container">
          <span>
            <CaseInfo
              title="Confirmed Cases"
              amount={cases.total.toLocaleString()}
            />
            <CaseInfo
              title="Active Cases"
              amount={cases.active.toLocaleString()}
            />
            <CaseInfo
              title="Total Deaths"
              amount={deaths.total.toLocaleString()}
            />
            <CaseInfo
              title="Recovered"
              amount={cases.recovered.toLocaleString()}
            />
          </span>
